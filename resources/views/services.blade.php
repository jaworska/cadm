...
@section('content')
    ...
    <div id="toggle-services" class="container-fluid why services">
        <div class="row">
    ...
    <div class="container-fluid companies services d-flex flex-column align-items-center">
        ...
        <div class="row w-100">
            ...
            <a href="{{ route("sectors") }}/#aerospace"  class="col-md-3 col-12 text-center d-flex flex-column align-items-center companies-hover d-flex click-aerospace">
                <div class="text-center d-flex flex-column align-items-center">
                    ...
                    <span class="pt-0">@lang('pages.services.aerospace')</span>
                    <span>@lang('pages.services.aerospace-span')</span>
                </div>
            </a>
        </div>
        <div class="row justify-content-center w-100">
            <a href="{{ route("sectors") }}/#others"  class="col-md-3 col-12 text-center d-flex flex-column align-items-center companies-hover d-flex click-others">
                <div class="text-center d-flex flex-column align-items-center">
