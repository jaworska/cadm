...
@section('content')
<div class="jumbotron video_main">
...
<div class="container-fluid brands position-sticky">
    <div class="row">
        <div class="col-12 d-flex align-items-md-center flex-sm-column flex-xs-column flex-md-row justify-content-between padding-container">
            <div class="text-left d-flex float-left align-items-center justify-content-between">
             ...
             img/volkswagen-logo@3x.png 3x"
                     class="volkswagen-logo">
                <img src="img/varroc-logo.png"
                     srcset="img/varroc-logo@2x.png 2x,
             img/varroc-logo@3x.png 3x"
                     class="varroc-logo">
                <img src="img/magna-logo.png"
                     srcset="img/magna-logo@2x.png 2x,
             img/magna-logo@3x.png 3x"
                     class="magna-logo">
                <img src="img/alstom-logo.png"
                     srcset="img/alstom-logo@2x.png 2x,
             img/alstom-logo@3x.png 3x"
                     class="alstom-logo">
                <img src="img/aptiv-logo.png"
                     srcset="img/aptiv-logo@2x.png 2x,
             img/aptiv-logo@3x.png 3x"
                     class="aptiv-logo">
                <img src="img/csi.png"
                     srcset="img/csi@2x.png 2x,
             img/csi@3x.png 3x"
                     class="csi">
                <img src="img/h.png"
                     srcset="img/h@2x.png 2x,
             img/h@3x.png 3x"
                     class="h">
