...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>CADM Automotive | Login</title>
    ...
    <link href="/metronic/assets/css/demo1/pages/custom/general/login/login-3.css" rel="stylesheet" type="text/css" />
...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v3 kt-login--signin" id="kt_login">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(/metronic/assets/media//bg/bg-3.jpg);">
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="{{route('home')}}">
                            <img alt="Logo" src="/img/logo-cadm@3x.png" srcset="/img/logo-cadm@2x.png 2x,
             /img/logo-cadm@3x.png 3x"/>
                        </a>
                    </div>
                    @yield('content')
                </div>
...
<script src="/metronic/assets/js/demo1/pages/login/login-general.js" type="text/javascript"></script>
