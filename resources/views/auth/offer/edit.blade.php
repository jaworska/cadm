        ...
        <div class="col-md-12">
            ...
            <form class="needs-validation" novalidate action="{{ route('offer.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Tytuł" value="{{$offer -> title}}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" id="description" required > {{$offer -> description}}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="range" class="form-control" id="range" required> {{$offer -> range}}</textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="requirements" class="form-control" id="requirements" required> {{$offer -> requirements}}</textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="offer" class="form-control" id="offer" required> {{$offer -> offer}}</textarea>
                    <div class="invalid-feedback">
