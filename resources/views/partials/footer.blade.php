<div class="container-fluid footer d-none d-md-block">
    <div class="row">
        ...
        <div class="col-2 nav-footer">
            ...
            <ul>
                <li><a href="#">@lang("pages.navigation.automotive")</a></li>
                <li><a href="#">@lang("pages.navigation.rolling")</a></li>
                <li><a href="#">@lang("pages.navigation.maritime")</a></li>
                <li><a href="#">@lang("pages.navigation.aerospace")</a></li>
                <li><a href="#">@lang("pages.navigation.others")</a></li>
            </ul>
        </div>
        <div class="col-2 nav-footer">
    ...
    <div class="row">
        ...
        <div class="col-2 nav-footer">
            <ul>
                ...
                <li><a href="#">@lang("pages.navigation.mbd")</a></li>
                <li><a href="#">@lang("pages.navigation.em")</a></li>
                <li><a href="#">@lang("pages.navigation.stackup")</a></li>
                <li><a href="#">@lang("pages.navigation.optical")</a></li>
                <li><a href="#">@lang("pages.navigation.gap")</a></li>
                <li><a href="#">@lang("pages.navigation.thickness")</a></li>
            </ul>
        </div>
        <div class="col-2 nav-footer">
            <ul>
...
<div class="container-fluid footer d-md-none d-sm-block">
    <div class="row">
        ...
        <div class="col-6 nav-footer margin-top-nav">
            <p>@lang("pages.navigation.range")</p>
            <ul>
                <li><a href="#">@lang("pages.navigation.concept")</a></li>
                <li><a href="#">@lang("pages.navigation.development")</a></li>
                <li><a href="#">@lang("pages.navigation.simulation")</a></li>
                <li><a href="#">@lang("pages.navigation.production")</a></li>
                <li><a href="#">@lang("pages.navigation.management")</a></li>
            </ul>
        </div>
    </div>
</div>
